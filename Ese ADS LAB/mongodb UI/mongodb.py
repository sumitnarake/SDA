...
# Connecting to DB
client = MongoClient(f"mongodb+srv://{MONGO_USER}:{MONGO_PASS}@cluster0.zawhgih.mongodb.net/test", server_api=ServerApi('1'))
...
usr_name = Label(window ,text = f"Connected to Cloud MongoDB as: Sumit", background = "white").grid(row = 0, column = 1, pady=20)
